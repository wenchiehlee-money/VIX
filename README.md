...
| **台指波動率 (Taiwan VIX)** | <!-- TW_VIX_VAL -->**23.12**<!-- /TW_VIX_VAL --> | <!-- TW_VIX_SENT -->市場關注<!-- /TW_VIX_SENT --> | <!-- TW_VIX_DATE -->2026-09-24<!-- /TW_VIX_DATE --> |
| **CNN 恐懼與貪婪指數** | <!-- CNN_FG_VAL -->**34.94**<!-- /CNN_FG_VAL --> | <!-- CNN_FG_SENT -->Fear<!-- /CNN_FG_SENT --> | <!-- CNN_FG_DATE -->2026-09-24<!-- /CNN_FG_DATE --> |
