...
| **台指波動率 (Taiwan VIX)** | <!-- TW_VIX_VAL -->**34.46**<!-- /TW_VIX_VAL --> | <!-- TW_VIX_SENT -->加重動盪<!-- /TW_VIX_SENT --> | <!-- TW_VIX_DATE -->2026-07-15<!-- /TW_VIX_DATE --> |
| **CNN 恐懼與貪婪指數** | <!-- CNN_FG_VAL -->**46.86**<!-- /CNN_FG_VAL --> | <!-- CNN_FG_SENT -->Neutral<!-- /CNN_FG_SENT --> | <!-- CNN_FG_DATE -->2026-07-15<!-- /CNN_FG_DATE --> |
