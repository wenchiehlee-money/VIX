...
| :--- | :---: | :---: | :---: |
| **美股波動率 (US VIX)** | <!-- US_VIX_VAL -->**16.33**<!-- /US_VIX_VAL --> | <!-- US_VIX_SENT -->溫和波動<!-- /US_VIX_SENT --> | 實時 (yfinance) |
| **台指波動率 (Taiwan VIX)** | <!-- TW_VIX_VAL -->**38.90**<!-- /TW_VIX_VAL --> | <!-- TW_VIX_SENT -->加重動盪<!-- /TW_VIX_SENT --> | <!-- TW_VIX_DATE -->2026-08-04<!-- /TW_VIX_DATE --> |
| **CNN 恐懼與貪婪指數** | <!-- CNN_FG_VAL -->**57.37**<!-- /CNN_FG_VAL --> | <!-- CNN_FG_SENT -->Greed<!-- /CNN_FG_SENT --> | <!-- CNN_FG_DATE -->2026-08-04<!-- /CNN_FG_DATE --> |
