...
| :--- | :---: | :---: | :---: |
| **ç¾Žè‚¡æ³¢å‹•çŽ‡ (US VIX)** | <!-- US_VIX_VAL -->**15.99**<!-- /US_VIX_VAL --> | <!-- US_VIX_SENT -->溫和波動<!-- /US_VIX_SENT --> | å¯¦æ™‚ (yfinance) |
| **å°æŒ‡æ³¢å‹•çŽ‡ (Taiwan VIX)** | <!-- TW_VIX_VAL -->**36.56**<!-- /TW_VIX_VAL --> | <!-- TW_VIX_SENT -->加重動盪<!-- /TW_VIX_SENT --> | <!-- TW_VIX_DATE -->2026-06-02<!-- /TW_VIX_DATE --> |
| **CNN ææ‡¼èˆ‡è²ªå©ªæŒ‡æ•¸** | <!-- CNN_FG_VAL -->**56.91**<!-- /CNN_FG_VAL --> | <!-- CNN_FG_SENT -->Greed<!-- /CNN_FG_SENT --> | <!-- CNN_FG_DATE -->2026-06-02<!-- /CNN_FG_DATE --> |
