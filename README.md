...
| :--- | :---: | :---: | :---: |
| **美股波動率 (US VIX)** | <!-- US_VIX_VAL -->**15.23**<!-- /US_VIX_VAL --> | <!-- US_VIX_SENT -->溫和波動<!-- /US_VIX_SENT --> | 實時 (yfinance) |
| **台指波動率 (Taiwan VIX)** | <!-- TW_VIX_VAL -->**35.19**<!-- /TW_VIX_VAL --> | <!-- TW_VIX_SENT -->加重動盪<!-- /TW_VIX_SENT --> | <!-- TW_VIX_DATE -->2026-08-10<!-- /TW_VIX_DATE --> |
| **CNN 恐懼與貪婪指數** | <!-- CNN_FG_VAL -->**66.14**<!-- /CNN_FG_VAL --> | <!-- CNN_FG_SENT -->Greed<!-- /CNN_FG_SENT --> | <!-- CNN_FG_DATE -->2026-08-10<!-- /CNN_FG_DATE --> |
